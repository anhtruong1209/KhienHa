    ...
    public static function make(): array
    {
        return [
            ...
            'history' => [
                ...
                ['id' => 3, 'year' => '2010', 'title' => 'Chuyển về An Lão', 'content' => 'Nhà máy chuyển về xã Chiến Thắng, An Lão với quy mô hạ tầng lớn hơn, tối ưu cho đóng tàu trọng tải cao.'],
                ['id' => 4, 'year' => '2016', 'title' => 'Chuẩn hóa quy trình', 'content' => 'Bổ sung quy trình kiểm soát kỹ thuật, hồ sơ nghiệm thu và giám sát chất lượng theo từng hạng mục sản xuất.'],
                ['id' => 5, 'year' => '2021', 'title' => 'Nâng cấp năng lực', 'content' => 'Được đánh giá và cấp chứng nhận năng lực đóng mới tàu đến 25.000 DWT, tạo bước tiến lớn về quy mô sản xuất.'],
                ['id' => 6, 'year' => '2025', 'title' => 'Mở rộng phân khúc dự án', 'content' => 'Tiếp nhận đồng thời nhiều gói đóng mới, cải hoán và sửa chữa tàu hàng, sà lan biển và tàu dịch vụ kỹ thuật.'],
            ],
            'capacity' => [
                ...
                ['id' => 5, 'category' => 'Điều hành dự án', 'title' => 'Tổ chức thi công theo tiến độ nhiều mũi', 'detail' => 'Phân luồng công việc theo từng block thân tàu, thiết bị máy, hệ trục và hệ điện để rút ngắn thời gian thi công các dự án trọng điểm.', 'icon' => 'Users', 'image' => 'https://khienha.vn/uploads/anh/724016468995605.jpg'],
                ['id' => 6, 'category' => 'Bến bãi', 'title' => 'Bãi lắp ráp và khu tập kết vật tư rộng', 'detail' => 'Khu tập kết tôn thép, thiết bị và block thành phẩm được bố trí liền mạch với tuyến vận chuyển nội bộ, giảm thời gian chờ và tăng năng suất.', 'icon' => 'Building2', 'image' => 'https://khienha.vn/uploads/anh/810916469000106.jpg'],
            ],
            'quality' => [
                ...
                'steps' => [
                    ['id' => 1, 'step' => 'Bước 1', 'title' => 'Kiểm tra vật tư đầu vào, chứng chỉ thép và hồ sơ kỹ thuật trước khi gia công.'],
                    ['id' => 2, 'step' => 'Bước 2', 'title' => 'Giám sát công đoạn cắt, tạo hình, lắp ráp và hàn thân tàu theo bản vẽ được phê duyệt.'],
                    ['id' => 3, 'step' => 'Bước 3', 'title' => 'Đo kiểm sai số kích thước, kiểm tra mối hàn và hiệu chỉnh trước khi chuyển sang công đoạn tiếp theo.'],
                    ['id' => 4, 'step' => 'Bước 4', 'title' => 'Kiểm tra hệ trục, máy chính, điện tàu, sơn phủ và hoàn thiện kỹ thuật theo checklist bàn giao.'],
                    ['id' => 5, 'step' => 'Bước 5', 'title' => 'Nghiệm thu nội bộ, chạy thử và hoàn thiện hồ sơ bàn giao theo tiêu chuẩn hiện hành.'],
                ],
            ],
            'goals' => [
                ...
                ['id' => 3, 'title' => 'Cam kết chất lượng', 'content' => 'Tập trung vào chất lượng, tiến độ, an toàn lao động và dịch vụ hậu mãi minh bạch trong toàn bộ vòng đời dự án.'],
                ['id' => 4, 'title' => 'Nâng cấp nhân lực', 'content' => 'Đầu tư đào tạo đội ngũ kỹ sư, cán bộ hiện trường và công nhân nòng cốt để đáp ứng yêu cầu kỹ thuật cao hơn mỗi năm.'],
                ['id' => 5, 'title' => 'Phát triển khách hàng dài hạn', 'content' => 'Xây dựng quan hệ đối tác bền vững với chủ tàu, đơn vị logistics và doanh nghiệp vận tải thủy trên toàn quốc.'],
            ],
            'gallery' => [
                ...
                ['id' => 6, 'url' => 'https://khienha.vn/uploads/anh/639616469009097.jpg', 'title' => 'Sà lan biển tải trọng lớn', 'category' => 'Sản phẩm'],
                ['id' => 7, 'url' => 'https://khienha.vn/uploads/anh/367316468994953.jpg', 'title' => 'Khu triền tàu ngoài bãi', 'category' => 'Hạ tầng'],
                ['id' => 8, 'url' => 'https://khienha.vn/uploads/anh/724016468995605.jpg', 'title' => 'Lắp đặt block thân tàu', 'category' => 'Thi công'],
                ['id' => 9, 'url' => 'https://khienha.vn/uploads/anh/810916469000106.jpg', 'title' => 'Tập kết vật tư dự án', 'category' => 'Vận hành'],
                ['id' => 10, 'url' => 'https://khienha.vn/uploads/anh/7851646900891Tau%20du%20lich.jpg', 'title' => 'Hoàn thiện tàu du lịch', 'category' => 'Bàn giao'],
            ],
            'banners' => [
                ...
                'https://khienha.vn/uploads/anh/233516468994642.jpg',
                'https://khienha.vn/uploads/anh/79371608532527Tau 9000T.jpg',
            ],
        ];
    }
}
